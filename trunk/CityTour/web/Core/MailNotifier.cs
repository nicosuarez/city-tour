    ...
    public class MailNotifier : IClientNotifier
    {
        ...
        public void NotifyReservationConfirmed(Reservation reservation)
        {
            ...
            {                
                ...
                var toAddress = new MailAddress(reservation.Person.EmailAddress, reservation.Person.Name);
        ...
        public void NotifyReservationCancelled(Reservation reservation, string message)
        {
